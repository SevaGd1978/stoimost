...
В папке [`tender-spy/`](tender-spy/README.md) — отдельное приложение для мониторинга тендеров ЕИС (44-ФЗ/223-ФЗ) по номенклатуре. Запуск: `cd tender-spy && npm install && npm start`.
